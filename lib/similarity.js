...
exports.getPearson = function(dataSet, key1, key2) {
	...
	for (var itemKey in sharedItems) {
		// console.log('dataSet[key1][itemKey]: ' + dataSet[key1][itemKey]);
		// console.log('dataSet[key2][itemKey]: ' + dataSet[key2][itemKey]);
	...
	// console.log('sharedItemsSum - (sum1 * sum2 / sharedItemsLength): ' + 
	// 	sharedItemsSum + '-' + '(' + sum1 + '*' + sum2 + '/' + sharedItemsLength + ')' );
